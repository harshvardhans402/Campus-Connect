        ...
        <div class="modal fade" id="welcome" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          ...
          <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-body">
                        ...
                        <p>This is Twitter clone made by <span style="font-weight: 700;">Harshvardhan Sharma</span> for
                            learning
                            purpose.</p>
                        <p>The platform includes post, repost , qoute or even qoute the qouted post , like post and
                            nested
                            comments.
                            you can mention or add hashtag to yout posts, change password or username.
                            Follow or unfollow people. get notification if any action happen. Search users by name or
                            username. and more!
                        </p>
                        <p>By Signing Up then you followed
                            <a style="color:#207ce5;" href="amin">@Harsh</a>
                            by default to see post. you can change it anytime!
                        </p>
                    </div>
            ...
            <div class="sidebar-left">
                <div class="grid-sidebar" style="margin-top: 12px">
                    <div class="icon-sidebar-align">
                        <img src="./assets/images/cmrlogo.jpg" alt="" height="50px" width="50px" />
                    </div>
                </div>
